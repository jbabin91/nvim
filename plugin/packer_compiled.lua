...
_G.packer_plugins = {
  ...
  ["cmp-vsnip"] = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/cmp-vsnip",
  ...
  fd = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/fd",
  ...
  neoformat = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/neoformat",
  ...
  ["popup-menu.nvim"] = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/popup-menu.nvim",
    url = "https://github.com/kamykn/popup-menu.nvim"
  },
  ripgrep = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/ripgrep",
    url = "https://github.com/BurntSushi/ripgrep"
  },
  ["spelunker.vim"] = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/spelunker.vim",
  ...
  ["vim-codefmt"] = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/vim-codefmt",
  ...
  ["vim-kitty"] = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/vim-kitty",
    url = "https://github.com/fladson/vim-kitty"
  },
  ["vim-maktaba"] = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/vim-maktaba",
    url = "https://github.com/google/vim-maktaba"
  },
  ["vim-polyglot"] = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/vim-polyglot",
  ...
  ["vim-sensible"] = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/vim-sensible",
    url = "https://github.com/tpope/vim-sensible"
  },
  ["vim-signify"] = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/vim-signify",
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
  ...
  ["vim-vsnip"] = {
    loaded = true,
    path = "/Users/jacebabin/.local/share/nvim/site/pack/packer/start/vim-vsnip",
