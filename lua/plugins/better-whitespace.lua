...
-- BUG: I don't know why but it seems we must again specificly run function for FileType dashboard.
-- we must have it in both whitespace_disabled_file_types and here
vim.cmd('autocmd FileType dashboard "DisableWhitespace" | autocmd BufLeave <buffer> lua whitespace_visibility(whitespace_disabled_file_types)')
