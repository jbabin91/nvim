...
local setup = {
  plugins = {
    ...
    -- the preset plugin, adds help for a bunch of default keybindings in Neovim
  ...
  show_help = true, -- show help message on the command line when the poppup is visible
  triggers = "auto", -- automatically setup triggers
  -- triggers = { "<leader>" }, -- or specify a list manually
  triggers_blacklist = {
    -- list of mode / prefixes that should never be hooked by WhichKey
    -- this is mostly relevant for key maps that start width a native binding
...
local mappings = {
  ...
  ["q"] = { "<cmd>q!<CR>", "Quit" },
  ["h"] = { "<cmd>nohlserch<CR>", "No Highlight" },
  ...
  g = {
    ...
    l = { "<cmd>lua require 'gitsigns'.blame_list()<CR>", "Blame" },
