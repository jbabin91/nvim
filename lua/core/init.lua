...
JB = {
  ...
  plugins = {
    ...
    toggleterm = {
      ...
      which_key = {
        ...
        definitions = {
          ...
          f = {"<cmd>lua JB.plugins.toggleterm.toggle_float()<cr>", "Floating Terminal"},
          l = {"<cmd>lua JB.plugins.toggleterm.toggle_lazygit()<cr>", "LazyGit"}
    ...
    packer = {
      enabled = true,
      -- See core/user-config/README.md for an example use of this
      init = {
        display = {
          open_fn = function()
            return JB.utils.plugins.require('packer.util').float {border = "single"}
          end
        }
      }
    },
