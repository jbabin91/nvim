...
opt.completeopt = { "menuone", "noselect" } -- mostly used for cmp
opt.conceallevel = 0 -- so that `` are visible in markdown files
opt.fileencoding = "utf-8" -- the encoding written to a file
opt.hlsearch = true -- highlight all matches on previous search pattern
opt.ignorecase = true -- ignore case in search patterns
opt.mouse = "a" -- allow the mouse to be used in neovim
opt.pumheight = 10 -- popup menu height
opt.showmode = false -- hide default mode view
...
opt.number = true -- set numbered line
...
opt.fillchars.eob = " " -- show empty lines at the end of a buffer as ` `
...
opt.whichwrap:append("<>[]hl") -- keys allowed to move to the previous/next line when the beginning/end of line is reached
opt.iskeyword:append("-") -- treats words with `-` as a single word
