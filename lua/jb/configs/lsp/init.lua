if not pcall(require, "nvim-lsp-installer") then
  print "Failed loading Lsp Intaller..."
end

local lsp_installer = require "nvim-lsp-installer"
local lsp_keymaps = require "jb.configs.lsp.keymaps"
local capabilities = require "jb.configs.lsp.capabilities"

require "jb.configs.lsp.handlers"
require "jb.configs.lsp.custom-server"
...
lsp_installer.on_server_ready(function(server)
    ...
    local server_opts = {
        ...
        ["jdtls"] = function()
            return vim.tbl_deep_extend("force", default_opts, {
                handlers = {
                    ["language/status"] = require "jb.configs.lsp.jdtls-progress"(),
                },
            })
        end,
    }
