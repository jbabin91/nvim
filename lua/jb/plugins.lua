...
local function spec(use)
  ...
  use {
    ...
    },
    {
      ...
      config = function()
        require("jb.configs.nvim-autopairs")
      end,
    },
    {
      "t9md/vim-choosewin",
  ...
  use {
    ...
    },
    {
      ...
      config = function()
        require("jb.configs.nvim-colorizer")
      end,
    },
  }
  ...
  if vim.fn.has "unix" == 1 then
    use {
      ...
      },
      {
        ...
        run = ":TSUpdate",
        config = function()
          require("jb.configs.nvim-treesitter")
        end,
      },
      {
