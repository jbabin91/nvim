...
local function setup_plugins_after_loaded()
  -- Run rooter when it is the first time entering neovim
  vim.cmd [[audocmd VimEnter * Rooter]]
  require "colors"
end
...
M.lsp_attach = function(client, bufnr)
  ...
  elseif client.resolved_capabilities.document_range_formatting then
    buf_set_keymap("n", "<space>m", "<cmd>lua vim.lsp.buf.range_formatting()<cr>", opts)
  end
end
