...
-- don't need to define explicitly but it won't make any differences
...
set.listchars = {
  nbsp     = "⦸",   -- CIRCLED REVERSE SOLIDUS (U+29BB, UTF-8: E2 A6 B8)
...
set.smartcase      = true
set.scrolloff      = 8                             -- when scrolling, keep cursor 1 lines away from screen border
...
set.expandtab      = true                          -- don't expand tabs into spaces
set.shiftround     = true
set.splitbelow     = true                          -- open horizontal splits below the current buffer
set.splitright     = false                         -- open vertical splits to the right of the current buffer
